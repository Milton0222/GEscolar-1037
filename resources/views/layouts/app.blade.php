...
<body class="font-sans antialiased">
    ...
    @livewireScripts
    <script src="{{asset('assetes/bootstrap/js/bootstrap.js')}}"> </script>
    <script>
        var dCurso1 =document.querySelector('#curso');
        dCurso1.style.display = 'none';

        function verificar(value) {
            var dCurso =document.querySelector('#curso');

            if (value == 'II Siculo')
                dCurso.style.display = "block";
            if(value == 'I Siculo')
            dCurso.style.display = 'none';
        }
    </script>
