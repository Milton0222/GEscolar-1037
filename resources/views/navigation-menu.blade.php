...
<nav class="navbar navbar-expand-lg bg-body-tertiary" style="color: black;">
  <div class="container-fluid" id="navbarNavDropdownl">
    ...
    <ul class="navbar-nav" id="navbar">
      ...
      <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="{{route('dashboard')}}"> <i class="fa-solid fa-home"></i></a>
        </li>
        ...
        Finanças
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink" id="ul-sub-menu">
            ...
            <li><a class="dropdown-item" href="{{route('comparticipar.index')}}">Pagamento</a></li>
      ...
      <li class="nav-item dropdown">
        ...
        @endif
                ...
                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex" id="navbarNavDropdownl">
